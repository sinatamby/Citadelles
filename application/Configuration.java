...
public class Configuration {
	public static Pioche nouvellePioche() {
		...
		for(int i=0;i<4;i++) {
			pioche.ajouter(new Quartier("Marché",Quartier.TYPE_QUARTIERS[3],2));
			pioche.ajouter(new Quartier("Château",Quartier.TYPE_QUARTIERS[2],4));
		}
		for(int i=0;i<3;i++) {
			...
			pioche.ajouter(new Quartier("Église",Quartier.TYPE_QUARTIERS[0],2));
			pioche.ajouter(new Quartier("Monastère",Quartier.TYPE_QUARTIERS[0],3));
		}
		for(int i=0;i<2;i++) {
	...
	public static PlateauDeJeu configurationDeBase(Pioche p) {
		...
		p.ajouter(new Quartier("Bibliothèque",Quartier.TYPE_QUARTIERS[4],6,""));
		p.ajouter(new Quartier("Carrière",Quartier.TYPE_QUARTIERS[4],5,""));
		...
		p.ajouter(new Quartier("Statue Équestre",Quartier.TYPE_QUARTIERS[4],3,""));
